...
![call your cat mod whistle cat minecraft datapack](https://cdn.jsdelivr.net/gh/jodeks-datapacks/Assets@main/titles/call_your_cat.png)
...
[![call your cat minecraft datapack github issues](https://cdn.jsdelivr.net/gh/jodeks-datapacks/Assets@main/badges/GH_Issues.png)](https://github.com/jodeks-datapacks/call-your-cat/issues)&nbsp;&nbsp;
...
**2.** Give the cat any name (it can not include special characters like # or ')

**3.** Hold any goat horn you want in your hand

**4.** Sneak and look at the cat for 4 seconds
...
--> Only the owner of the cat can get the goat horn + use the goat horn to call the cat
...
<h5>I know this isn't the Call Your Cat mod, but it works the same</h5>
