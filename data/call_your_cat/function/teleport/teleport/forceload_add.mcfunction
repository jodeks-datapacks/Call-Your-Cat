...
data modify storage call_your_cat:root data.cat_UUID_latest_position_x_forceload set from storage call_your_cat:root data.cat_UUID_latest_position_x
data modify storage call_your_cat:root data.cat_UUID_latest_position_z_forceload set from storage call_your_cat:root data.cat_UUID_latest_position_z
