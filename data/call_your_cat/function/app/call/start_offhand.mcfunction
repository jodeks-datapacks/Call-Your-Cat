advancement revoke @s only call_your_cat:used/goat_horn_offhand

scoreboard players set &UUID_check call_your_cat.check 1

execute as @s run function jodek:api/data/get/offhand_stored_uuid with storage call_your_cat:root data
...
execute as @s run function call_your_cat:app/call/get_data with storage call_your_cat:root