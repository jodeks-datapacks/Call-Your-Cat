...
scoreboard objectives add check.call_your_cat dummy

scoreboard objectives add use_goat_horn_cat minecraft.used:minecraft.goat_horn

scoreboard objectives add store_position.call_your_cat dummy

scoreboard objectives add sneak_time.call_your_cat custom:sneak_time

scoreboard objectives add call_your_cat.image dummy

scoreboard objectives add raycast_steps.call_your_cat dummy

scoreboard players set @a sneak_time.call_your_cat 0

scoreboard players set @a use_goat_horn_cat 0
scoreboard players set &time_since_goat_horn_use check.call_your_cat 0

scoreboard players set &teleported check.call_your_cat 0
